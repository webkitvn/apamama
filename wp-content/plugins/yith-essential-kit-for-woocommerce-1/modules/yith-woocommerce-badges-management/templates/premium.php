...
<div class="landing">
    ...
    <div class="section section-even clear" style="background: url(<?php echo YITH_WCBM_ASSETS_URL ?>/images/13-bg.png) no-repeat #fff; background-position: 85% 100%">
        <div class="landing-container">
            <div class="col-1">
                <img src="<?php echo YITH_WCBM_ASSETS_URL ?>/images/13.png" alt="badge for multiple products" />
            </div>
            <div class="col-2">
                <div class="section-title">
                    <img src="<?php echo YITH_WCBM_ASSETS_URL?>/images/13-icon.png" alt="icon 11" />
